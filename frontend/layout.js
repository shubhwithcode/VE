/**
 * Vishwakarma Premium Layout Management
  ...
  <header class="siteHeader adminHeader">
    <div class="navContainer adminNavContainer">
      <a href="${adminHomeHref}" class="logo adminLogo">
        <div class="logoBadge">V</div>
        <div class="logoTextContainer">
          <span class="logoMain">Vishwakarma Admin</span>
    ...
    <div id="mobileMenu" class="mobileOverlay adminMobileOverlay">
      ...
      <div class="mobileMenuFooter">
        <p>Vishwakarma Executive Workspace</p>
  ...
  <header class="siteHeader">
    <div class="navContainer">
      <a href="${homeHref}" class="logo">
        <div class="logoBadge">V</div>
        <div class="logoTextContainer">
          <span class="logoMain">Vishwakarma</span>
      ...
      <nav class="navLinks">
        ...
        <a href="${adminHref}" class="navLink">Admin</a>
        <a href="${staffHref}" class="navLink">Staff</a>
      </nav>
    ...
    <div id="mobileMenu" class="mobileOverlay">
      ...
      <div class="mobileMenuContent">
        ...
        <a href="${adminHref}" class="mobileMenuLink" onclick="toggleMenu(false)">
          <div class="mLinkInfo">
            <span class="mLinkTitle">Admin Portal</span>
            <span class="mLinkSub">Executive Dashboard</span>
          </div>
          <span class="material-symbols-rounded">chevron_right</span>
        </a>
        <a href="${staffHref}" class="mobileMenuLink" onclick="toggleMenu(false)">
          <div class="mLinkInfo">
            <span class="mLinkTitle">Staff Portal</span>
            <span class="mLinkSub">Production Management</span>
          </div>
          <span class="material-symbols-rounded">chevron_right</span>
        </a>
      </div>
      <div class="mobileMenuFooter">
        <p>© Vishwakarma Premium Furniture</p>
    ...
    <nav class="mobileBottomNav">
      ...
      <a href="${adminHref}" class="mobileNavItem ${currentPath.includes('admin/') ? 'active' : ''}">
...
function buildFooter(prefix) {
  ...
  <footer class="siteFooter adminFooter">
    ...
    <div class="container adminFooterBottom">
      <div>&copy; <span id="year"></span> Vishwakarma Enterprises Admin</div>
  ...
  <footer class="siteFooter">
    <div class="container footerGrid">
      <div class="footerBrand">
        <h2 style="font-family: 'Playfair Display'; color: var(--gold-accent); font-size: 2.2rem; margin-bottom: 24px;">Vishwakarma.</h2>
      ...
      <div class="footerCol">
        ...
        <ul class="footerLinks">
          ...
          <li><a href="${prefix}admin/login.html">Partner Login</a></li>
